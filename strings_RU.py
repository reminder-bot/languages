...
Убедитесь что таймер не превышает 50 лет вперёд.''',
        ...
        'success' : '''Новое уведомление будет отослано {location} через {offset} секунд. Если вы хотите отменить, напишите `$del`.''',
    },
...
Example:
    ...
    ```{prefix}interval 0s 10s Это будет очень интересно```''',
        ...
        'short_interval' : '''Убедитесь что интервал настроен не чаще 8 секунд.''',
